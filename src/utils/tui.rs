...
pub fn run(config_file: PathBuf, config_lang: Language) -> Result<()> {
    ...
    let mut app = App {
        ...
        current_config: load(&config_file, config_lang),
        config_file,
        config_lang,
    };
        ...
        loop {
            terminal.draw(|f| {
                ...
                f.render_stateful_widget(
                    list,
                    centered_rect(50, 50, *chunks.get(0).unwrap_or(&size)),
                ...
                match self.current_window {
                    Window::Home => {
                        if let Some(s) = self.current_popup {
                            match s {
                                ...
                                2 => {
                                    popups_home::max_window_width(&mut self.current_popup_state, f);
                                }
                                // 3, 4 and 5 dont need a popup
                                6 => popups_home::focus_behavior(
                                    &self.current_config,
                                    &mut self.current_popup_state,
                                    f,
                                ),
                                7 => popups_home::insert_behavior(
                                    &self.current_config,
                                    &mut self.current_popup_state,
                                    f,
                                ),
                                8 => popups_home::layout_mode(
                                    &self.current_config,
                                    &mut self.current_popup_state,
                                    f,
                                ),
                    ...
                    Window::Workspaces { .. } => {
                        if let Some(s) = self.current_popup {
                            match s {
                                0 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
                                    "X".to_string(),
                                    f,
                                ),
                                1 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
                                    "Y".to_string(),
                                    f,
                                ),
                                2 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
                                    "Widht".to_string(),
                                    f,
                                ),
                                3 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
                                    "Height".to_string(),
                                    f,
                                ),
                                4 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
                                    "Id".to_string(),
                                    f,
                                ),
                                5 => popups_workspaces::text_input(
                                    &mut self.current_popup_state,
            ...
            match key.code {
                KeyCode::Up => {
                    if self.current_popup.is_none() {
                        match self.config_list_state.selected() {
                            ...
                            Some(_) => {
                                previous(&mut self.config_list_state, self.config_list.len());
                            }
                        }
                ...
                KeyCode::Left => {
                    ...
                    if let Window::Workspaces { index, empty } = self.current_window {
                        if !empty {
                            if index == 0 {
                                self.current_window = Window::Workspaces {
                                    index: (self.current_config.workspaces.clone().unwrap().len()
                                        - 1),
                                    empty,
                                };
                            } else {
                        ...
                        if !empty {
                            if index == 0 {
                                self.current_window = Window::Tags {
                                    index: (self.current_config.tags.clone().unwrap().len() - 1),
                                    empty,
                                };
                            } else {
                                self.current_window = Window::Tags {
                ...
                KeyCode::Enter => {
                    match self.current_window {
                            ...
                            if let Some(s) = self.config_list_state.selected() {
                                if self.current_popup.is_none() {
                                    match s {
                                        ...
                                        1 => {
                                            ...
                                            match self
                                                ...
                                                .clone()
                                                .unwrap_or_else(|| {
                                                    KeyModifier::Single("None".to_string())
                                                })
                                                .to_string()
                                                .as_str()
                                            {
                                        ...
                                        2 => {
                                            ...
                                            self.current_popup_state =
                                                PopupState::String(String::new());
                                        }
                                        3 => {
                                        ...
                                        9 => {
                                            ...
                                            for l in &self.current_config.layouts {
                                                match l {
                                                    ...
                                                    WMLayout::CenterMainBalanced => {
                                                        selected.push(9);
                                                    }
                                                    WMLayout::CenterMainFluid => selected.push(10),
                                                    WMLayout::Monocle => selected.push(11),
                                                    WMLayout::RightWiderLeftStack => {
                                                        selected.push(12);
                                                    }
                                                    WMLayout::LeftWiderRightStack => {
                                                        selected.push(13);
                                                    }
                                                }
                                            }
                                            ...
                                            self.current_popup_state =
                                                PopupState::MultiList(MultiselectListState {
                                                    liststate,
                                                    selected,
                                                });
                                        }
                                    ...
                                    match s {
                                            ...
                                            if let PopupState::List(s) = &self.current_popup_state {
                                                if let Some(s) = s.selected() {
                                                    match s {
                                                        ...
                                                        1 => {
                                                            self.current_config.mousekey =
                                                                Some(KeyModifier::Single(
                                                                    "Shift".to_string(),
                                                                ));
                                                        }
                                                        2 => {
                                        ...
                                        2 => {
                                            self.current_config.max_window_width =
                                                if let PopupState::String(s) =
                                                    &self.current_popup_state
                                                {
                                                    if s.contains('.') {
                                        ...
                                        6 => {
                                            if let PopupState::List(l) = &self.current_popup_state {
                                                match l.selected() {
                                                    Some(0) => {
                                                        self.current_config.focus_behaviour =
                                        ...
                                        7 => {
                                            if let PopupState::List(l) = &self.current_popup_state {
                                                match l.selected() {
                                                    Some(0) => {
                                                        self.current_config.insert_behavior =
                                                            InsertBehavior::Top;
                                                    }
                                                    Some(1) => {
                                                        self.current_config.insert_behavior =
                                        ...
                                        8 => {
                                            if let PopupState::List(l) = &self.current_popup_state {
                                                match l.selected() {
                                                    Some(0) => {
                                                        self.current_config.layout_mode =
                                                            LayoutMode::Tag;
                                                    }
                                                    Some(1) => {
                                                        self.current_config.layout_mode =
                                                ...
                                                &self.current_popup_state
                                            {
                                                ...
                                                for s in &l.selected {
                                                    match s {
                                                        ...
                                                        9 => layouts
                                                            .push(WMLayout::CenterMainBalanced),
                                                        10 => {
                                                            layouts.push(WMLayout::CenterMainFluid);
                                                        }
                                                        11 => layouts.push(WMLayout::Monocle),
                                                        12 => layouts
                                                            .push(WMLayout::RightWiderLeftStack),
                                                        13 => layouts
                                                            .push(WMLayout::LeftWiderRightStack),
                                                        _ => {}
                                                    }
                                                }
                            ...
                            if empty {
                                ...
                                match s {
                                    ...
                                    5 => {
                                        ...
                                        self.current_config
                                            ...
                                            .get_mut(index)
                                            .unwrap()
                                            .max_window_width = if let PopupState::String(s) =
                                            &self.current_popup_state
                                        {
                                            if s.contains('.') {
                                                Some(Size::Ratio(s.parse().unwrap_or(0.0)))
                                        ...
                                        if let PopupState::MultiList(l) = &self.current_popup_state
                                        {
                                            ...
                                            for s in &l.selected {
                                                match s {
                                                    ...
                                                    11 => layouts.push(WMLayout::Monocle),
                                                    12 => {
                                                        layouts.push(WMLayout::RightWiderLeftStack);
                                                    }
                                                    13 => {
                                                        layouts.push(WMLayout::LeftWiderRightStack);
                                                    }
                                                    _ => {}
                                                }
                                            }
                                ...
                                match s {
                                    ...
                                    11 => {
                                        ...
                                        {
                                            self.current_window =
                                                Window::Workspaces { index, empty: true };
                                        }
                                    }
                                    _ => {}
                                }
                        ...
                        Window::Tags { index, empty } => match self.current_popup {
                            Some(_) => {
                                self.current_config.tags.as_mut().unwrap().remove(index);
                                self.current_config.tags.as_mut().unwrap().insert(
                                    index,
                                    if let PopupState::String(s) = &self.current_popup_state {
                                        s.clone()
                                    } else {
                            ...
                            None => match self.config_list_state.selected().unwrap_or(0) {
                                2 => {
                                    if empty {
                                        self.current_config
                                            .tags
                                        ...
                                        self.current_popup = Some(0);
                                        self.current_popup_state =
                                            PopupState::String(String::default());
                                    }
                                }
                                4 => {
                                    self.current_config
                                ...
                                5 => {
                                    ...
                                    if index >= self.current_config.tags.as_ref().unwrap().len()
                                        && index > 0
                                    {
                                        self.current_window = Window::Tags {
                                            index: index - 1,
                ...
                //space
                KeyCode::Char(' ') => match self.current_window {
                    Window::Home => {
                ...
                KeyCode::Char(c) => match self.current_window {
                    Window::Home => match self.current_popup {
                        Some(2) => {
                    ...
                    Window::Workspaces { .. } => match self.current_popup {
                        Some(0..=5) => {
                            if let PopupState::String(s) = &mut self.current_popup_state {
                                if "1234567890,.".contains(c) {
                                    s.push(c);
                    ...
                    Window::Tags { .. } => match self.current_popup {
                        Some(0) => {
                            if let PopupState::String(s) = &mut self.current_popup_state {
                                s.push(c);
                            }
                ...
                if let Some(c) = current_workspace {
                    vec![
                        ListItem::new(format!(
                            "{} out of {}",
                            index + 1,
                            self.current_config.workspaces.as_ref().unwrap().len()
                        )),
                        ListItem::new("--------------------------"),
                ...
                if let Some(c) = current_workspace {
                    vec![
                        ListItem::new(format!(
                            "{} out of {}",
                            index + 1,
                            self.current_config.tags.as_ref().unwrap().len()
                        )),
                        ListItem::new("--------------------------"),
